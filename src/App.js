...
const statuses = ["Currently Reading", "Want to Read", "Read"];
const books = [
  {
                 ...
                 <div className="bookshelf">
                    ...
                    <div className="bookshelf-books">
                      <ol className="books-grid">
                        <ListBooks books={books} shelfStatus="currentlyReading" />
                      </ol>
                    </div>
                  </div>
                  <div className="bookshelf">
                    ...
                    <div className="bookshelf-books">
                      <ol className="books-grid">
                        <ListBooks books={books} shelfStatus="wantToRead" />
                      </ol>
                    </div>
                  </div>
                  <div className="bookshelf">
                    ...
                    <div className="bookshelf-books">
                      <ol className="books-grid">
                        <ListBooks books={books} shelfStatus="read" />
                      </ol>
                    </div>
                  </div>
              </div>
